...
function Buttons(props) {
  ...
  return (
    <div className={`${props.darkMode?'bg-[#686868]':'bg-white shadow-black'} transition-all duration-500 ${props.display?'scale-100':'scale-0'} w-20 h-48 top-16 right-[21rem] flex  flex-col rounded-2xl fixed shadow-2xl`}>
    <div>
